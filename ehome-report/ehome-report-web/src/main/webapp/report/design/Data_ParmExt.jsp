...
<head lang="zh-cn">
    ...
    <script>
        ...
        function initTree(){
            var parms=$(parent.rdes.document.getElementById('parmsExtModel').value);
            $("#dslist").empty();
        ...
        function dsop(id){
            var vvv=parent.rdes.document.getElementById('parmsExtModel').value;
            if(vvv==''||vvv==undefined) vvv='<parmsExtList></parmsExtList>';
            var parms=$(vvv);
            switch(id){
                case "add":
                    $('#reset').click();
                ...
                case "del":
                	...
                	parent.rdes.document.getElementById('parmsExtModel').value='<parmsExtList>'+parms.html()+'</parmsExtList>';
        ...
        <form method="get" class="dsform" id="dsform" action="">
            <fieldset>
                ...
                <p>
                    ...
                    <span style="color:red">注：select单选、多选候选值传通过参数传递，默认为：参数名称_selectlist=name:value,name:value……</span>
                </p>
                <p>
                    <label class="p">参数类型</label>
                ...
                <p>
                    ...
                    <select name="dbType" id="dbType" class="sel" title="请选择数据类型" required>
                ...
                <p>
                    <label class="p">操作符</label>
                    <select name="parmvl" id="parmvl" class="sel">
                    <option value="eq">等于</option>
                    <option value="!eq">不等于</option>
                    <option value="lt">大于</option>
                    <option value="rt">小于</option>
                    <option value="lteq">大于等于</option>
                    <option value="gteq">小于等于</option>
