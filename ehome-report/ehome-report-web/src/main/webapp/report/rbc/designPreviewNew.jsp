...
.confirmbtn {
	...
	background: rgba(0, 0, 0, 0) url('../images/domeBg1.png') repeat-x scroll 0 0;
}

table tbody td.link {
	cursor: pointer;color:blue !important;
}
...
<script type="text/javascript">
	...
	if(fx==undefined){fx=3}
		...
		}else if(page>1){//第二页开始不再读取表头表尾
				var nbody=$('<div>'+bodyhtml+'</div>');
				$('.page3 .dynamic tbody').html(nbody.find('.dynamic tbody').html());
				bodyhtml=$('.page3 div').html();
		}
